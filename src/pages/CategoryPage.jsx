...
function CategoryPage() {
  ...
  return (
    <div className="bg-mauve-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 w-full  px-6 pb-10 pt-10">
        {meals?.map((item) => (
          <Link
            key={item.idMeal}
          ...
          >
            ...
            />
            <h3 className="p-3 font-semibold text-center">{item.strMeal}</h3>
          </Link>
        ))}
      </div>
    </div>
